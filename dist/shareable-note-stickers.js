...
//my.Placement = 'above'|'below'
  ...
  onRender(() => {
    ...
    function drawLine(x0, y0, x1, y1, Text) {
      Context.beginPath();
    ...
    if (Placement === "above") {
      ...
      for (let x = 0; x <= Width; x += 10) {
        switch (true) {
          case x % 100 === 0:
            drawLine(x, Height, x, Height - 15, x);
            break;
          case x % 50 === 0:
            drawLine(x, Height, x, Height - 10);
            break;
          default:
            drawLine(x, Height, x, Height - 7);
        }
      }
    } else {
      Context.textAlign = "center";
  ...
  onRender(() => {
    ...
    if (Placement === "left") {
      ...
      for (let y = 0; y <= Height; y += 10) {
        switch (true) {
          case y % 100 === 0:
            drawLine(Width, y, Width - 15, y, y);
            break;
          case y % 50 === 0:
            drawLine(Width, y, Width - 10, y);
            break;
          default:
            drawLine(Width, y, Width - 7, y);
        }
      }
    } else {
